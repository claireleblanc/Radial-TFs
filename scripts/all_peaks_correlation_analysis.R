##  CORRELATION ANALYSIS FOR ALL PEAKS
##  Author: Claire LeBlanc
##  Last modified: 2022/8/18

##  Usage: Ran on consennsus peak files generated by nf-core/chipseq pipeline
...
filenames <- c("Myeloid/ELF4/K562/ENCAB606JHO.consensus_peaks.bed",
               "Myeloid/E2F4/K562/E2F4_consensus_peaks.bed",
               "Myeloid/Max/K562/ENCAB000AIL.consensus_peaks.bed",
               "Myeloid/NRF1/K562/ENCAB000BLK.consensus_peaks.bed",
               "Myeloid/TCF12/K562-exp1/ENCAB521XDP.consensus_peaks.bed",
               "Myeloid/TCF12/K562-exp2/ENCAB506UYG.consensus_peaks.bed",
               "Myeloid/TCF12/Kasumi/TCF12_consensus_peaks.bed",
               "Lymphoid/ATF4/Jurkat/ATF4-cDNA_consensus_peaks.bed",
               "Lymphoid/FOXP1/SUDHL4/FOXP1_consensus_peaks.bed",
               "Lymphoid/FOXP1/RCK8/FOXP1_consensus_peaks.bed",
               "Lymphoid/GATA3/Jurkat/GATA3.consensus_peaks.bed",
               "Lymphoid/GATA3/RPMI8402/GATA3.consensus_peaks.bed",
               "Lymphoid/GATA3/thymocyte/anti-GATA3.consensus_peaks.bed",
               "Lymphoid/NFATC1/GM12878/ENCAB000AJE.consensus_peaks.bed",
               "Lymphoid/PRDM1/U266B1/PRDM1.consensus_peaks.bed")


ndf <- lapply(filenames, count_binned_sites_corr)
df_coors <- data.frame(do.call(rbind,ndf))

#make columns the correct types
